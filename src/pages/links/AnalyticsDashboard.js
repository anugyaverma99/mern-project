...
//core js library (not speific to react) for rendering charts
...
// regiser so that these elements are ready to use by react-chartjs-2 which is react wrapper to use chart.js
...
function AnalyticsDashboard(){
    ...
    const [fromDate,setFromDate]=useState(null);    //default value null because these both are optional fields
    ...
    const fetchLinkAnalytics=async()=>{
        ...
        console.log(response.data);
            ...
            console.log(error);
            //navigating to error page if we are not able to fetch link analytics , because 
            //then there would be no point to render component if we dont have any data
